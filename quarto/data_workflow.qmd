...
'media_unique_keys' contains the unique keys of each occurence table by 'media_type_id'
...
# 
#   # 'media_unique_keys' contains the unique keys of each occurence table by 'media_type_id'
# occurrences_files <-   occurrences_files |> left_join( media_unique_keys )
```
...
references_files <- references_columns |> 
  ...
  nest(col_info = col_pos : description)
