...
#     return(out[[1]])
#   }
#   try(sort(out_temp, decreasing = TRUE)[[1]])
# }
...
#     return(out[[1]])
#   } else {
#     return(sort(out_temp, decreasing = TRUE)[[1]])
#   }
# }
...
check_previous_year(occurrences_files$full_file_name,
                    occurrences_files$year)
occurrences_files |> 
  mutate(max_date = max_date_year(full_file_name,year))
