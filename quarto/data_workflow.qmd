...
```{r}
data(get_row_numbers)
x <- get_row_numbers |> 
  rename(n_lines_w_header = n_rows_no_header,
         n_rows = n_rows_w_header) |> 
  mutate(across(!full_file_name, as_numeric2))
save(x, file = "~/Documents/r_wd/adtabler/data/get_row_numbers.rda")
```
