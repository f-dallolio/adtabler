...
# plan(sequential)
# 
# names(x_occs$df) <-   glue::glue("{x_occs$file_name_std}_id{numpad2(x_occs$media_type_id)}")
# 
# x_occs$df
# 
# 
...
# occs_refs <- x_occs |> 
#   mutate(
#     media_desc = paste(media_type_id, media_type_desc_std, sep = "__"),
#     .after = file_name_std
#   ) |> 
#   bind_rows(
#     x_refs |> 
...
#   select(-media_type_id, media_type_desc_std, file_name_std)
# 
# 
# usethis::use_data(occs_refs, overwrite = T)
