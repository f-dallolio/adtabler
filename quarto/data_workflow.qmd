...
# data("occurrences_ukey")
# 
# occurrences_columns <- occurrences_columns |>
#   left_join(
#     occurrences_ukey |>
#       transmute(media_type_id,
#                 col_name_std = rename_adintel(ukey_man),
#                 col_unique_key = col_name_std)
#     ) |>
#   relocate(col_unique_key, .after = col_name_std) |>
#   relocate(media_type_id, .before = 1)
```

```{r}
# data("references_columns")
# data("references_ukey")
# 
# occurrences_nms <- occurrences_columns |>
#   select(-media_type_id) |>
#   names()
# 
# references_columns <- references_columns |>
#   left_join(references_ukey) |>
#   mutate(col_unique_key = if_else(!is.na(col_name_ref), col_name_std, NA)) |>
#   select(-(file_name_ref:col_name_ref)) |>
#   relocate(col_name_std, col_unique_key, .after = col_pos) |>
#   select(any_of(occurrences_nms))
```
